...
-- SELECT name FROM v$datafile; (verificar ruta datafile)
...
--ALTER USER JUANA QUOTA UNLIMITED ON JUANA; (para versiones antiguas)

GRANT CONNECT, CREATE SESSION, CREATE TABLE, CREATE VIEW, CREATE SEQUENCE, CREATE TRIGGER TO JUANA;
...
VALUES ('Cien años de soledad', 45.00, 'Novela de Gabriel García Márquez');

INSERT INTO PRODUCTOS (NOMBRE, PRECIO, DESCRIPCION)
VALUES ('Rayuela', 38.50, 'Obra de Julio Cortázar');
